...
description: >
  This vignette includes the lecture slides for the correlation section of the course (part 8/12).
vignette: >
...
- We can just look at *r* to determine "model fit" or strength of relationship.
...
- Correlation is both an effect size and a statistical test. What should I check for data screening? 
...
- But what about *p* values for our statistical test? 
...
- What have we learned?
    ...
    - Correlation is a test statistic and an effect size
