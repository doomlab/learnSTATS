...
Using `MeMoBootR`, let's calculate a mediation analysis with number of years mediating the relationship between affective measurements and the OCB. Be sure to print out the Sobel test and the bootstrapped results to answer questions. 
...
```{r mediation-effect}
question_text(
  "Is there any evidence of mediation? Explain both Sobel and bootstrapping.",
